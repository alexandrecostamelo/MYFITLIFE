...
Monitoring: `HEALTH_CHECK_TOKEN`, `HEARTBEAT_*_URL` (16 crons: AUTOPILOT, PROACTIVE, WEEKLY_SUMMARY, DAILY_CLEANUP, NFSE_QUEUE, PIX_RENEWALS, PIX_CHECK_PAYMENTS, NFSE_SUB_QUEUE, PREMIUM_QUOTA_RESET, BACKUP, WEARABLE_SYNC, WINBACK_EMAIL, UNPAUSE_SUBSCRIPTIONS, APPLY_SCHEDULED_CHANGES, CHALLENGES_STATUS, VIDEO_ROOMS_CLEANUP)

Email: `RESEND_API_KEY`

TTS: `ELEVENLABS_API_KEY` (opcional — fallback retorna 501 se ausente)

Videoconferência: `DAILY_API_KEY` (Daily.co para salas de vídeo)
